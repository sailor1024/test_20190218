...
Object.assign(TextureManager.prototype, {
    loadTexture(index, ifcanmove) {
        ...
        // if (ifcanmove) {//影响漫游事件所以屏蔽
            ...
            group.position.set(modelData.viewPoints[index].x,-0.18,modelData.viewPoints[index].z);
...
function initLoadedModel(group) {
    ...
    if (model) {
        ...
        model.children[0].material.map.encoding = THREE.LinearEncoding; // .sRGBEncoding;颜色平均亮度
...
function initComposer() {
  ...
  var  renderPass = new THREE.RenderPass(scene, cameraController.orbitCamera);
