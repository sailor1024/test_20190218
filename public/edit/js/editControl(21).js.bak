...
function KeyAddEvent(a) {
    renderMeshKey = a
    // if (a) {
    //     Keytimer = setInterval(renderMesh, 1);
    // } else {
...
function renderMesh() {
    ...
    // console.log("canJump",canJump,"spaceUp",spaceUp);
    //获取当前按键的方向并获取朝哪个方向移动
...
function TagDivContentSave(structural) {
    ...
    if (str == '.mp3' || str == '.m4a' || str == '.WMA' || str == '.APE' || str == '.FLAC' || str == '.AAC' || str == 'AC3' || str == '.MMF' || str == '.AMR' || str == '.M4R' || str == '.OGG' || str == '.MAV' || str == '.WavPack' || str == '.MP2') {
        Marker = 'audio'
    } else if (str == '.mp4') {
        Marker = 'iframe'
    } else if (str == '.jpg' || str == '.psd' || str == '.gif' || str == '.jpeg' || str == '.png' || str == '.pdf' || str == '.svg') {
        Marker = 'img'
    } else {
        Marker = ''
    }
