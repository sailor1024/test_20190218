...
function animate1(ele, target) {
    ...
    var speeds = 1/windowswidth;//根据宽度调整播放速度
...
function slider() {
    ...
    $('#mapBtn2D').click(function() {
        ...
        var windowswidth = window.innerWidth * 0.002; //20180920ning自适应窗口宽度
        ...
        if (modelmaxX > modelmaxY) {
            animate1(orthoCamera, (5.5 / modelmaxX * windowswidth).toFixed(2))
        } else {
            animate1(orthoCamera, (5.5 / modelmaxY * windowswidth).toFixed(2))
        }
...
function goCurrentViewPoint(currentSlideIndex, orient) {

    // console.log(currentSlideIndex);
    setWalkingViewPoint(currentSlideIndex, orient);
